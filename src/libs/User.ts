 ...
 */
export function oauth_userinfo(params: UserinfoParams): Promise<UserinfoResult> {
 ...
 */
export function fans_list(params: FansListParams): Promise<FansListResult> {
 ...
 */
export function following_list(params: FollowingListParams): Promise<FollowingListResult> {
 ...
 */
export function fans_check (params:FansCheckParams):Promise<FansCheckResult>{
