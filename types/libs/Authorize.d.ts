 ...
 */
export declare function platform_oauth_connect(params: ConnectParams): Promise<Result>;
/**
 ...
 */
export declare function oauth_accesstoken(data: AccesstokenParams): Promise<AccesstokenResult>;
/**
 ...
 */
export declare function oauth_renew_refresh_token(data: RenewRefreshTokenParams): Promise<RenewRefreshTokenResult>;
/**
 ...
 */
export declare function oauth_client_token(data: ClientTokenParams): Promise<ClientTokenResult>;
/**
 ...
 */
export declare function oauth_refresh_token(data: RefreshTokenParams): Promise<RefreshTokenResult>;
/**
 ...
 * @returns {Promise<Result>}
 */
export declare function oauth_authorize_v2(params: AuthorizeV2Params): Promise<Result>;
