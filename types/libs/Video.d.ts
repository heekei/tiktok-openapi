 ...
 */
export declare function VideoUpload(params: VideoUploadUrlParam, body: VideoUploadBodyData): Promise<VideoUploadResult>;
/**
 * @description 分片初始化上传
 * @scope video.create
 ...
 */
export declare function VideoPartUploadInit(params: VideoUploadUrlParam): Promise<VideoPartUploadInitResult>;
/**
 * @description 分片上传
 * @scope video.create
 ...
 */
export declare function VideoPartUpload(params: VideoPartUploadUrlParam, body: VideoPartUploadBodyData): Promise<Result>;
/**
 * @description 分片上传完成
 * @scope video.create
 ...
 * @return {*}  {Promise<VideoUploadResult>}
 */
export declare function VideoPartUploadFinish(params: VideoPartUploadUrlParam): Promise<VideoUploadResult>;
/**
 * @description 创建抖音视频
 * @scope video.create
 ...
 */
export declare function VideoCreate(params: VideoUploadUrlParam, body: VideoCreateBodyData): Promise<VideoCreateResult>;
