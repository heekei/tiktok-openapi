(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TiktokOpenAPI = {}, global.require$$1, global.require$$2, global.require$$0, global.require$$3, global.require$$4, global.require$$8));
   ...
   * 接口地址前缀
   */
  var OAUTH_API_HOST = 'https://open.douyin.com';
   ...
   */
  function platform_oauth_connect(params) {
   ...
   */
  function oauth_accesstoken(data) {
   ...
   */
  function oauth_renew_refresh_token(data) {
   ...
   */
  function oauth_client_token(data) {
   ...
   */
  function oauth_refresh_token(data) {
   ...
   * @returns {Promise<Result>}
   */
  function oauth_authorize_v2(params) {
  ...
  var Authorize = /*#__PURE__*/Object.freeze({
    __proto__: null,
    platform_oauth_connect: platform_oauth_connect,
    oauth_accesstoken: oauth_accesstoken,
    oauth_renew_refresh_token: oauth_renew_refresh_token,
    oauth_client_token: oauth_client_token,
    oauth_refresh_token: oauth_refresh_token,
    oauth_authorize_v2: oauth_authorize_v2
  });
   ...
   * @returns {Promise<Result>}
   */
  function oauth_userinfo(params) {
      return ajax.get('/oauth/userinfo/', {
          params: params
      });
  }
  /**
   ...
   */
  function fans_list(params) {
      return ajax.get('/fans/list/', {
          params: params
      });
  }
  /**
   ...
   */
  function following_list(params) {
      return ajax.get('/following/list/', {
          params: params
      });
  }
  /**
   ...
   */
  function fans_check(params) {
      return ajax.get('/fans/check/', {
          params: params
      });
  }
...
if(typeof window !== 'undefined') {
  window._TiktokOpenAPI_VERSION_ = '1.0.0'
}
